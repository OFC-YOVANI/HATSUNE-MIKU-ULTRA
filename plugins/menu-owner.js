...
➟ *𝗛ᴏʟᴀ,➟${taguser}*
➟ *ᴏᴡɴᴇʀ:ᴏғᴄ➟ʏᴏᴠᴀɴɪ*
➟ *Hola Bienvenid@ al menu de owner los comandos de esta lista solo los pude usar el/al propietario del bot usalos de forma correcta*
...
handler.command = /^(PROPIETARIO|propietario|Propietario)$/i
handler.fail = null
